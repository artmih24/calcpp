...
void PrintHelpInfo() {
    ...
    std::cout << "    3 % 2                - mod" << std::endl;
    std::cout << "    3 // 2               - true division" << std::endl;
    ...
    std::cout << "        abs(x)           - |x| (absolute value of x)" << std::endl;
    std::cout << "        sin(x)           - sin of x (x value is in radians)" << std::endl;
    std::cout << "    inv(sqrt(x))         - functions also can be nested" << std::endl;
    std::cout << "    invsqrt(x)           - you can use more complex functions made from basic functions!" << std::endl;
